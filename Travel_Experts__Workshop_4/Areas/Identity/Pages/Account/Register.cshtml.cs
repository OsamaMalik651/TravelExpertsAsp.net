...
namespace Travel_Experts__Workshop_4.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<Travel_Experts__Workshop_4User> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Travel_Experts__Workshop_4User { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName };
